...
const SIGNAGE = {
    ...
    "portfolio-navbar4":   { word: "NOVA", color: "cyan" },
    "portfolio-hero1":     { word: "INTRO", color: "purple" },
    "portfolio-hero2":     { word: "IMPACT", color: "purple" },
    "portfolio-hero3":     { word: "SHINE", color: "purple" },
    "portfolio-hero4":     { word: "ORBIT", color: "purple" },
    "portfolio-projects1": { word: "CASE", color: "teal" },
    "portfolio-projects2": { word: "SHOW", color: "teal" },
    "portfolio-projects3": { word: "WORK", color: "teal" },
    "portfolio-projects4": { word: "VAULT", color: "teal" },
    "portfolio-aboutus1":  { word: "ABOUT", color: "pink" },
    "portfolio-aboutus2":  { word: "FLOW", color: "pink" },
    "portfolio-aboutus3":  { word: "IMPACT", color: "pink" },
    "portfolio-aboutus4":  { word: "CONNECT", color: "pink" },
    ...
    "portfolio-template5": { word: "V4SET", color: "gray" },
};
